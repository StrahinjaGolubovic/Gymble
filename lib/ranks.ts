...
export function getRankColorStyle(trophies: number): { color: string } {
  if (trophies < 250) return { color: '#cd7f32' }; // Bronze - classic bronze
  if (trophies < 500) return { color: '#c0c0c0' }; // Silver - classic silver
  if (trophies < 1000) return { color: '#ffd700' }; // Gold - classic gold
  if (trophies < 1500) return { color: '#22d3ee' }; // Platinum - bright cyan
  if (trophies < 2000) return { color: '#3b82f6' }; // Diamond - brilliant blue
  if (trophies < 3000) return { color: '#000000' }; // Pro - black (professional)
  if (trophies < 4000) return { color: '#a855f7' }; // Locked - purple (mystery)
  if (trophies < 5000) return { color: '#ef4444' }; // Furious - intense red
  if (trophies < 6000) return { color: '#f97316' }; // Gymrat - orange (energy)
  if (trophies < 7000) return { color: '#eab308' }; // Elite - golden yellow
  if (trophies < 8000) return { color: '#ec4899' }; // Dominant - hot pink (power)
  if (trophies < 9000) return { color: '#95D600' }; // Monster - lime green
  if (trophies < 10000) return { color: '#8b5cf6' }; // Legend - royal purple
  return { color: '#dc2626' }; // Beast - deep red (ultimate)
}
...
export function getRankGradient(trophies: number): string {
  ...
  if (trophies < 3000) return 'bg-gradient-to-br from-gray-900/60 to-gray-800/40 border-2'; // Pro
  ...
  if (trophies < 6000) return 'bg-gradient-to-br from-orange-900/60 to-orange-700/40 border-2'; // Gymrat
  if (trophies < 7000) return 'bg-gradient-to-br from-yellow-800/60 to-yellow-700/40 border-2'; // Elite
  if (trophies < 8000) return 'bg-gradient-to-br from-pink-900/60 to-pink-800/40 border-2'; // Dominant
  if (trophies < 9000) return 'bg-gradient-to-br from-lime-900/60 to-lime-800/40 border-2'; // Monster
  if (trophies < 10000) return 'bg-gradient-to-br from-purple-800/60 to-purple-700/40 border-2'; // Legend
  return 'bg-gradient-to-br from-red-800/60 to-red-700/40 border-2'; // Beast
}
...
export function getRankBorderStyle(trophies: number): { borderColor: string } {
  ...
  if (trophies < 2000) return { borderColor: '#3b82f6' }; // Diamond
  if (trophies < 3000) return { borderColor: '#000000' }; // Pro
  if (trophies < 4000) return { borderColor: '#a855f7' }; // Locked
  if (trophies < 5000) return { borderColor: '#ef4444' }; // Furious
  if (trophies < 6000) return { borderColor: '#f97316' }; // Gymrat
  if (trophies < 7000) return { borderColor: '#eab308' }; // Elite
  if (trophies < 8000) return { borderColor: '#ec4899' }; // Dominant
  if (trophies < 9000) return { borderColor: '#95D600' }; // Monster
  if (trophies < 10000) return { borderColor: '#8b5cf6' }; // Legend
  return { borderColor: '#dc2626' }; // Beast
}
